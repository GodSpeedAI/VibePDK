...
#
# See usage and taxonomy:
# - Docs: {{cookiecutter.project_slug}}/docs/vibecoding/reference/prompts.md
# - Index: {{cookiecutter.project_slug}}/docs/vibecoding/reference/index.md
# - Each prompt/mode carries frontmatter fields: kind/domain/task[/phase]
...
# TODO: Integrate with the VS Code CLI or Copilot API here. For example (illustrative only):
